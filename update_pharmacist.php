...
if (isset($_SESSION['role']) && $_SESSION['role'] === 'Pharmacist') {
    ...
    $stmt = $conn->prepare("SELECT u.*, ph.* FROM users u JOIN pharmacist ph ON u.user_id = ph.user_id WHERE u.user_id = ?");
...
<?php include "header.html";?>
    ...
    <div class="update-form">
        <!-- Update Username -->
        <form action="update_pharmacist.php" method="post">
            <label for="username">Username:</label>
            <input type="text" id="username" name="username" value="<?php echo $pharmacist['username']; ?>" required>
        ...
        <form action="update_pharmacist.php" method="post">
            ...
            <input type="text" id="full_name" name="full_name" value="<?php echo $pharmacist['full_name']; ?>" required>
        ...
        <form action="update_pharmacist.php" method="post">
            ...
            <input type="text" id="contact_number" name="contact_number" value="<?php echo $pharmacist['contact_number']; ?>" required>
