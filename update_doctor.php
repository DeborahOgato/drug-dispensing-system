...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="update_doctor.css">
</head>
<body>
<?php include "header.html";?>
    ...
    <div class="update-form">
        ...
        <form action="update_doctor.php" method="post">
            ...
            <input type="text" id="username" name="username" value="<?php echo $doctor['username']; ?>" required>
        ...
        <form action="update_doctor.php" method="post">
            ...
            <input type="text" id="full_name" name="full_name" value="<?php echo $doctor['full_name']; ?>" required>
        ...
        <form action="update_doctor.php" method="post">
            ...
            <input type="text" id="contact_number" name="contact_number" value="<?php echo $doctor['contact_number']; ?>" required>
        ...
        <form action="update_doctor.php" method="post">
            ...
            <input type="submit" name="update_specialization" value="Update">
        </form>
    </div>
    ...
    if (isset($_POST['update_specialization'])) {
        ...
        $update_stmt = $conn->prepare("UPDATE doctors SET specialization = ? WHERE user_id = ?");
        $update_stmt->bind_param('ss', $new_specialization, $user_id);
        $update_result = $update_stmt->execute();

        if ($update_result) {
            echo "<p>Specialization updated successfully!</p>";
        } else {
